...
## [1.0.0](https://github.com/JerrettDavis/rtk/compare/v0.43.0...v1.0.0) (2026-07-14)


### ⚠ BREAKING CHANGES

* **mvn:** `rtk mvn <args>` output format changed. Previously: TOML filter strips INFO/Downloading lines and caps at 50 lines. Now: state-machine filter with Surefire block collapse + locale guard + verbose bypass. Different output shape; significantly better savings tier; behaviour is otherwise a superset (all previously-handled cases still handled, plus test/verify/etc.).

### Features

* address pr suggestions ([9bd6e6f](https://github.com/JerrettDavis/rtk/commit/9bd6e6f3929cf320193e34a2654603afa1e9fa91))
* **benchmark:** add multipass VM integration test suite ([6e7863b](https://github.com/JerrettDavis/rtk/commit/6e7863bf313b0d18a47cf0ca2cdaea03cc2ed900))
* **benchmark:** add multipass VM integration test suite ([d22759b](https://github.com/JerrettDavis/rtk/commit/d22759b8c5254ad9c4a455f10cb7de75e92df581))
* **benchmark:** add Swift ecosystem tests (6 commands + savings) ([1fbb6d9](https://github.com/JerrettDavis/rtk/commit/1fbb6d935b4a0d031a7862cba312eebe1303ba9b))
* **cicd:** add auto next release parser ([bf24972](https://github.com/JerrettDavis/rtk/commit/bf24972e7d463f0432b8315e3035e9eb13ff062f))
* **cicd:** add auto next release parser ([f3e33f3](https://github.com/JerrettDavis/rtk/commit/f3e33f38872008fe0046e2e139a6762845504b8e))
* **cicd:** enforce cicd sast & package check ([3bbbb49](https://github.com/JerrettDavis/rtk/commit/3bbbb492f33f0e619ab0d1dbce4389ad49e763ae))
* **cicd:** target develop branch ([63da7da](https://github.com/JerrettDavis/rtk/commit/63da7dafd61b5f65115989aeda01f666a64457ff))
* **copilot:** CLI native integration ([a9a978c](https://github.com/JerrettDavis/rtk/commit/a9a978c10aa5ad5156ba7e324b87434b2b452ade))
* **discover:** handle more npm/npx/pnpm/pnpx patterns ([9e96caa](https://github.com/JerrettDavis/rtk/commit/9e96caa0a18a95c84da82ba57716a9d3ef86d0c8))
* **discover:** handle more npm/npx/pnpm/pnpx patterns ([bab3a53](https://github.com/JerrettDavis/rtk/commit/bab3a53f24f95a4a5821b23712f0b7f2ce3e0445))
* **gains:** add --reset flag ([e3149cb](https://github.com/JerrettDavis/rtk/commit/e3149cb7fbed18eae95f753664ddd8eaaaf6cc39))
* **glab:** add GitLab CLI (glab) command support ([048f2f9](https://github.com/JerrettDavis/rtk/commit/048f2f980bd95c5918f309d1d7ebc096d196f00d))
* **glab:** add GitLab CLI (glab) command support ([bc31f3f](https://github.com/JerrettDavis/rtk/commit/bc31f3f0f39077884e8d52c3508e840b355f682e)), closes [#851](https://github.com/JerrettDavis/rtk/issues/851)
* **gradlew:** add Gradle/gradlew support with streaming filters ([71d285f](https://github.com/JerrettDavis/rtk/commit/71d285fc42d2a97d6d1472bb96fff2db9ab39bab))
* **gradlew:** Gradle support for Android/Kotlin developers ([833026b](https://github.com/JerrettDavis/rtk/commit/833026b893822be4e1c64d22d640e979cd9eff51))
* **grep:** sort content alphabetically ([307b557](https://github.com/JerrettDavis/rtk/commit/307b5573838d24cc59191c12422ef1f216b9a087))
* **hermes:** add Hermes Agent support via rtk init --agent hermes ([55f998d](https://github.com/JerrettDavis/rtk/commit/55f998d08cd80ece970fe5e61eaae3533512288b))
* **hermes:** add rtk integration ([9d3b99d](https://github.com/JerrettDavis/rtk/commit/9d3b99dec8516fd32071d151306b5bb6fd4d06e3))
* **hints:** add tail hints for tee & hints + address reviews ([46fe7c4](https://github.com/JerrettDavis/rtk/commit/46fe7c47293fcbef28159ddc9fcd118a344cc42b))
* **hook:** --global Copilot install + transparent rewrite via modifiedArgs ([4b0bbf2](https://github.com/JerrettDavis/rtk/commit/4b0bbf269b34e953bf08b6d15b2ffc13cf812fb3))
* **hook:** add pi support ([805caf7](https://github.com/JerrettDavis/rtk/commit/805caf7d069e93370a316682b36aad59d562de2e))
* **hooks:** add Pi coding agent integration ([1da5793](https://github.com/JerrettDavis/rtk/commit/1da5793b9293cca5fca3e316bda18ed02443f2e2))
* **hooks:** add transparent_prefixes config for wrapper commands ([998f1ee](https://github.com/JerrettDavis/rtk/commit/998f1ee0a3cf8d73ea0d6d87c121117f351e4992))
* **hook:** wire Copilot into uninstall, telemetry, and discover ([84b703d](https://github.com/JerrettDavis/rtk/commit/84b703d7d02d0fa9b25ab9a39ccc467da2eba440))
* **init:** add --dry-run flag to preview changes without writing ([172ec54](https://github.com/JerrettDavis/rtk/commit/172ec54580ddb0d737ef3e3be8a075eaeeb0a01b))
* **init:** add --dry-run flag to preview changes without writing ([21a069a](https://github.com/JerrettDavis/rtk/commit/21a069ad76c3d8ffeee870d24408b1942cee691c))
* **init:** remove --pi flag, canonicalize Pi install to --agent pi ([cb1661e](https://github.com/JerrettDavis/rtk/commit/cb1661e68d995e72bec49fb0e619fd8178f376a4))
* **js:** distinguish between `jest` and `vitest` and don't rewrite `npm test` commands as we don't know which test framework is used under the hood ([45938b2](https://github.com/JerrettDavis/rtk/commit/45938b2a4d3fe76685a6e008f210bb276df50319))
* **mvn:** cap failing-class blocks and Failures summary entries ([be6c812](https://github.com/JerrettDavis/rtk/commit/be6c812416610f91025df2b49735c61c5f075fb3))
* **mvn:** filter mvn -q quiet-mode output ([97dbf98](https://github.com/JerrettDavis/rtk/commit/97dbf98cc6cb6ee7d5a3ba4d29450924142df4ee))
* **mvn:** Rust module replacing TOML filter, adds test phase support ([6c4950e](https://github.com/JerrettDavis/rtk/commit/6c4950e8258c424ea34a371833ead6bbcdaedc0a))
* **oc:** add Openshift CLI support with shared k8s filtering ([39cbb96](https://github.com/JerrettDavis/rtk/commit/39cbb968970d705d2080fc4062397f5b8650b595))
* **oc:** add Openshift CLI support with shared k8s filtering ([c7f493b](https://github.com/JerrettDavis/rtk/commit/c7f493b0cd0fbe9ed1d2da8ea66f86f2ca26cd01))
* **pnpm:** Add filter argument support ([2ba8d37](https://github.com/JerrettDavis/rtk/commit/2ba8d372df186b4056a3b8906fc25cde8586dd42))
* **pnpm:** handle pnpm build rewrite ([f936138](https://github.com/JerrettDavis/rtk/commit/f93613881939bc278261e9143bd328c82c696a33))
* prefer short args and cleanup comments ([53b5e79](https://github.com/JerrettDavis/rtk/commit/53b5e79561fdf98f09db0b5b2006ec838fcd06f5))
* **pulumi:** add CLI filters for preview/up/destroy/refresh/stack ([ced70c6](https://github.com/JerrettDavis/rtk/commit/ced70c6f0dcccd85365dcc78ca58f6b330d799e8))
* **pulumi:** add CLI filters for preview/up/destroy/refresh/stack ([d02ea0d](https://github.com/JerrettDavis/rtk/commit/d02ea0d446154c4086df95c7d5aecc94eaa112b5))
* **refacto-core:** binary hook w/ native cmd exec + streaming ([e7b7f9a](https://github.com/JerrettDavis/rtk/commit/e7b7f9ab665a0f7303d41d23ad156d24e5e8964e))
* rm rtk awareness injection ([b2a3ad9](https://github.com/JerrettDavis/rtk/commit/b2a3ad9443d6242f60b4c05265bda56b2a7e72b6))


### Bug Fixes

* '...' ascii to unicode, remove some comments ([3571d52](https://github.com/JerrettDavis/rtk/commit/3571d5293dc463c2a0aadfa9a5587b18478ca99a))
* address PR review comments ([ccf3a02](https://github.com/JerrettDavis/rtk/commit/ccf3a020ea6641482b31a0a841806ca156fe6a50))
* **aws:** guard the s3 ls and s3 sync/cp text emits ([25a095e](https://github.com/JerrettDavis/rtk/commit/25a095e90d7f8320d80577177f7623b13fa1bbad))
* **aws:** preserve values in JSON output for unsupported subcommands ([9574007](https://github.com/JerrettDavis/rtk/commit/9574007f77fa7051e93d10c512809e60ed61ac57))
* **aws:** preserve values in JSON output for unsupported subcommands ([ad2bfd3](https://github.com/JerrettDavis/rtk/commit/ad2bfd3225587ab2487f122868e4ea6e5facea7d))
* **benchmark:** address PR review feedback ([87ee81f](https://github.com/JerrettDavis/rtk/commit/87ee81f08be5e7b1ca79513b1a91925d455f4f5c))
* **benchmark:** address review feedback from @FlorianBruniaux ([d13c185](https://github.com/JerrettDavis/rtk/commit/d13c185aac64d14288b574df44623723a69e7b95))
* **benchmark:** benchmark capture all fd only stream ([c590bd6](https://github.com/JerrettDavis/rtk/commit/c590bd69329bb82608666958c7e06bf169a7d577))
* **benchmark:** capture all fd for stream cmd benchmark ([e6c2523](https://github.com/JerrettDavis/rtk/commit/e6c2523be1180772e40c175e2f9a523d349fb13d))
* **benchmark:** extract format_diff_changes + remove wrong diff test ([e7ae6bf](https://github.com/JerrettDavis/rtk/commit/e7ae6bf018882dba248f151ba4ec4929300b3e36))
* **ccusage:** add --yes flag and warn when falling back to npx ([f68fa00](https://github.com/JerrettDavis/rtk/commit/f68fa0087c03d6882993b7b3eaee98e1dbab41b4))
* **cicd:** : no semgrep alert on sh call cicd ([7681daf](https://github.com/JerrettDavis/rtk/commit/7681dafc76f164cfad588fe37d9a165dcb476e10))
* **cicd:** match ":" for body prefix to catch ([5987333](https://github.com/JerrettDavis/rtk/commit/5987333209cd59c1e22f9e0b247ab390cb431dbf))
* **cicd:** match allowed repo list in pr bodies ([b1233ab](https://github.com/JerrettDavis/rtk/commit/b1233ab3fbc0927145d5c0f763725b098fc7dd99))
* **cicd:** MIT to Apache 2.0 ([5a149a7](https://github.com/JerrettDavis/rtk/commit/5a149a7fdb92afe758a0c28d805873ce61d8259f))
* **cicd:** MIT to Apache 2.0 ([e132896](https://github.com/JerrettDavis/rtk/commit/e132896d3f3b588813f59790a5c2f7d35e40cb78))
* **cicd:** pr-target clean msg + git app token ([e4c3ed7](https://github.com/JerrettDavis/rtk/commit/e4c3ed7d889ede726df7986ade94a4714c7c7f99))
* **cicd:** pr-target clean msg + git app token ([4ebda52](https://github.com/JerrettDavis/rtk/commit/4ebda52f5ab898f9c0e8c610cc51b36a63e6eefa))
* **cicd:** set release-please target-branch to master [skip ci] ([0c6a838](https://github.com/JerrettDavis/rtk/commit/0c6a838594e87346b67bd13c092b8a46a783af87))
* **ci:** pin fixture line endings, harden CRLF tests ([be28a51](https://github.com/JerrettDavis/rtk/commit/be28a511797fb5214ff0784f57f491d2b7dd0e71))
* **ci:** use GITHUB_TOKEN for release-please-action (remove GitHub App secret dependency) ([#3](https://github.com/JerrettDavis/rtk/issues/3)) ([c63848c](https://github.com/JerrettDavis/rtk/commit/c63848c521558e87999c0c6bbc72606387dc818b))
* **copilot-cli:** use user-level instruction for -g ([e3ad973](https://github.com/JerrettDavis/rtk/commit/e3ad9736177116b637da17faaf38f70312ab6148))
* **core:** never-worse output guard ([af81b08](https://github.com/JerrettDavis/rtk/commit/af81b08175af063c8b631979959d80c9007d089f))
* **core:** never-worse output guard so RTK never exceeds the raw command ([861a46d](https://github.com/JerrettDavis/rtk/commit/861a46dee57f50216862ac83b0ee57974f383203))
* **core:** review 956 various fix ([840571f](https://github.com/JerrettDavis/rtk/commit/840571fe90ed14fb7e96f9b9000a1bac6d196d23))
* correct ARCHITECTURE.md path in README links ([2a41e03](https://github.com/JerrettDavis/rtk/commit/2a41e039903049543aa6c69482747eddcce9ee5a))
* correct ARCHITECTURE.md path in README links ([f2da381](https://github.com/JerrettDavis/rtk/commit/f2da381ae2353d31dd7252af6c868c56f6aa3db8))
* **curl:** gate force_tee_hint, extend JSON heuristic, avoid full-body alloc ([2ed53c7](https://github.com/JerrettDavis/rtk/commit/2ed53c7fa26922860af20c445b39cbb66862f180))
* **curl:** JSON passthrough + IsTerminal gate to prevent invalid JSON output ([02da3d0](https://github.com/JerrettDavis/rtk/commit/02da3d070271f800731a94a3249f3feb9dd7c7b8)), closes [#1536](https://github.com/JerrettDavis/rtk/issues/1536) [#1282](https://github.com/JerrettDavis/rtk/issues/1282)
* **curl:** passthrough binary downloads to prevent UTF-8 corruption ([a2a63e1](https://github.com/JerrettDavis/rtk/commit/a2a63e15f4d34f5de35eb7dc32eadb0b02f77327)), closes [#1087](https://github.com/JerrettDavis/rtk/issues/1087)
* **curl:** passthrough binary downloads to prevent UTF-8 corruption ([#1087](https://github.com/JerrettDavis/rtk/issues/1087)) ([35273c2](https://github.com/JerrettDavis/rtk/commit/35273c2dc1c94dd93ba97555e72b4e46928574b6))
* **curl:** skip JSON schema conversion for internal/localhost URLs ([577c311](https://github.com/JerrettDavis/rtk/commit/577c311ecaaa8ae94f22dbe252152424d4333d04))
* **diff:** report modified-only diffs and follow diff exit convention ([3a73bcd](https://github.com/JerrettDavis/rtk/commit/3a73bcdffc553c0b1b81ea423b98b221468a7289))
* **diff:** report modified-only diffs and follow diff exit convention ([c126d45](https://github.com/JerrettDavis/rtk/commit/c126d4594b4af1c59b8163178923207d4e9b6de4)), closes [#2364](https://github.com/JerrettDavis/rtk/issues/2364)
* **discover:** also encode '_', '\', and non-ASCII chars in project path slug ([73a05c3](https://github.com/JerrettDavis/rtk/commit/73a05c3262b6410cb24370d939c428d1dc0c7a77)), closes [#1457](https://github.com/JerrettDavis/rtk/issues/1457)
* **discover:** encode '.' as '-' in project path slug ([2d031f3](https://github.com/JerrettDavis/rtk/commit/2d031f32e9ad4452c2cc229c030ea6c0936c8bec)), closes [#1457](https://github.com/JerrettDavis/rtk/issues/1457)
* **discover:** exclude_commands bypass for env-prefix, sub cmd + regex ([ca4c59c](https://github.com/JerrettDavis/rtk/commit/ca4c59c230306d310069bed3c0ba930068dc4dc4))
* **discover:** exclude_commands bypass for env-prefix, sub cmd + regex ([42d3161](https://github.com/JerrettDavis/rtk/commit/42d3161872713bc0b20ef49b0714add40c40d5e3))
* **discover:** preserve golangci-lint flags in rewrite ([d85303e](https://github.com/JerrettDavis/rtk/commit/d85303ec4893deb904260f5dc11b7df906a50c07))
* **discover:** skip head/tail rewrite when multiple files are passed ([#1362](https://github.com/JerrettDavis/rtk/issues/1362)) ([ec3a4e9](https://github.com/JerrettDavis/rtk/commit/ec3a4e96fdcda6592afb08fb0ad0afaf41e07385))
* **discover:** weighted savings rate per bucket, decimal already_rtk percent ([82c62eb](https://github.com/JerrettDavis/rtk/commit/82c62eb893966b8f170ea22ec72e79f14789e12e))
* **discover:** word boundary in exclude_commands ([0ea115b](https://github.com/JerrettDavis/rtk/commit/0ea115bca5fa66daa69fda2f0eeaaf103346b3a4))
* **docker:** forward --tail flag in compose logs ([5f1d8b0](https://github.com/JerrettDavis/rtk/commit/5f1d8b0e14f0a0f82cd139443a80e680249c3137))
* **docker:** forward --tail flag in compose logs ([b70b0fe](https://github.com/JerrettDavis/rtk/commit/b70b0feec680356db81561d3920a3a9373dd43d8))
* **docker:** make the agent's command authoritative for the guard baseline ([b52db52](https://github.com/JerrettDavis/rtk/commit/b52db52da065f65f9838e7fd12c496b7d28d06e8))
* **docker:** report 0 containers/images instead of empty output ([3d4189c](https://github.com/JerrettDavis/rtk/commit/3d4189cc6304a8eefc7ab94388b268054b94a634))
* **docs:** add missing docs for exclude commands patterns ([2e401ac](https://github.com/JerrettDavis/rtk/commit/2e401ac38feec88de8d5e46f0301c8a532b95614))
* **docs:** replace remaining MIT license references with Apache 2.0 ([4c099e4](https://github.com/JerrettDavis/rtk/commit/4c099e4b5f64793ea95e14ac3fef96125f3a6fff))
* **docs:** replace remaining MIT license references with Apache 2.0 ([9bbc7bb](https://github.com/JerrettDavis/rtk/commit/9bbc7bb79e702ada58f5cfe2499d441715aa6bbd))
* **docs:** use release please changelog no manual ([7591a14](https://github.com/JerrettDavis/rtk/commit/7591a14e4ceb732ab7ca160ac01a852926abe77a))
* **docs:** user facing docs ([c8d6878](https://github.com/JerrettDavis/rtk/commit/c8d68787fb8b31c52125e9fc7ea62e0aa590485f))
* don't inject -json for go test -bench runs ([380a7c9](https://github.com/JerrettDavis/rtk/commit/380a7c9f1189fafe7d0b878b3821a720ac6ab4b2))
* don't inject -json for go test -bench runs ([b058c96](https://github.com/JerrettDavis/rtk/commit/b058c960f48535227cdec93392a70ee84f3cd2ee)), closes [#1609](https://github.com/JerrettDavis/rtk/issues/1609)
* dotnet cmd test flakiness ([17ffe62](https://github.com/JerrettDavis/rtk/commit/17ffe624d415f05ca4c29e97ca650594778231be))
* **dotnet:** 🐛 format build/test/restore output sections ([106305b](https://github.com/JerrettDavis/rtk/commit/106305b1978ad5fdd47139d3543cfa53a5e8172e))
* **dotnet:** 🐛 format build/test/restore output summaries ([271bc53](https://github.com/JerrettDavis/rtk/commit/271bc53f35c23b39dc42002e8eb3032557f845ec))
* **dotnet:** 🐛 format warnings section in build/test/restore outputs ([c5245d7](https://github.com/JerrettDavis/rtk/commit/c5245d74fafc066072615d804c27d5c2892db7d9))
* **dotnet:** keep raw fallback when parsed failures incomplete ([5e7eab5](https://github.com/JerrettDavis/rtk/commit/5e7eab5846cfe2de1f0d0c2a7d6c38c8de6c65e5))
* **dotnet:** move build/test/restore status line to the bottom ([ed161b0](https://github.com/JerrettDavis/rtk/commit/ed161b0a33a2a784bb933792501aa2747b0df3c3)), closes [#1574](https://github.com/JerrettDavis/rtk/issues/1574)
* **dotnet:** stop duplicating failures on failing test runs ([2d9dc1a](https://github.com/JerrettDavis/rtk/commit/2d9dc1ab9e0d25bf7fa6b8696f8909a561dd267f)), closes [#2501](https://github.com/JerrettDavis/rtk/issues/2501)
* **dotnet:** stop duplicating failures on failing test runs ([#2501](https://github.com/JerrettDavis/rtk/issues/2501)) ([6946bf9](https://github.com/JerrettDavis/rtk/commit/6946bf9562a26c7248d64d76564619a7d8dd4dd6))
* **env:** clean up feature from secrets rewrite ([223dda2](https://github.com/JerrettDavis/rtk/commit/223dda2996c061e93605d996a14d454a56198ec4))
* **filters:** add test for aggressive filter batch fix ([f6b28c2](https://github.com/JerrettDavis/rtk/commit/f6b28c292b517d55733ad1d3868f320b017901a5))
* **filters:** address adversarial test-suite findings on aggressive filtering ([62fc0e0](https://github.com/JerrettDavis/rtk/commit/62fc0e0d2159e82aaa8c36a18d69ca569a1ce0b5))
* **filters:** aggresivity batch fix ([90c285c](https://github.com/JerrettDavis/rtk/commit/90c285c38057a552f3e2ea8459fe82d715a9dd17))
* **filters:** benchmark ci update + fix stream + filter quality ([137af04](https://github.com/JerrettDavis/rtk/commit/137af0493189a86020da1feaa1de74df92466137))
* **filters:** benchmark ci update + fix stream filter quality ([88d9f6a](https://github.com/JerrettDavis/rtk/commit/88d9f6a0d94fd2b5b3d40c956e966756670a2704))
* **filters:** remove max_lines cap from helm filter that truncates template output ([63a76de](https://github.com/JerrettDavis/rtk/commit/63a76dedff245173a8e9240e09c741552f318de3))
* **filters:** remove max_lines cap from helm filter that truncates template output ([6b30fdd](https://github.com/JerrettDavis/rtk/commit/6b30fdd9fc78f910219f69ab4b73d5df440c14a5)), closes [#1626](https://github.com/JerrettDavis/rtk/issues/1626)
* **filters:** split docker ps/-a paths, cap ruff violations at 50 ([f21b864](https://github.com/JerrettDavis/rtk/commit/f21b8642dea5ac37ade5308bcf443315d63665e8))
* **find:** include hidden files when pattern targets dotfiles ([#1101](https://github.com/JerrettDavis/rtk/issues/1101)) ([dbeeaed](https://github.com/JerrettDavis/rtk/commit/dbeeaed16aee79674ec2fd3778b7b11b10b847c6))
* fmt ([bcee6cc](https://github.com/JerrettDavis/rtk/commit/bcee6cc2ea97a77201772112eee7125ce24e2be4))
* **gh,glab:** don't pre-reject view/checks/run subcommands missing the id ([3c8d29a](https://github.com/JerrettDavis/rtk/commit/3c8d29a57d6f1e3e1e50d0535540ea6fdff1d393))
* **gh,glab:** don't pre-reject view/checks/run subcommands missing the id ([e1bb17f](https://github.com/JerrettDavis/rtk/commit/e1bb17f85d387816621a6e77eca44f94458c4e81))
* **gh:** show fallback note when PR/issue body is filtered to empty ([4128572](https://github.com/JerrettDavis/rtk/commit/41285725e446706204943d826d89e19608df0c03)), closes [#235](https://github.com/JerrettDavis/rtk/issues/235)
* **git:** address review feedback on status state surfacing ([316e65e](https://github.com/JerrettDavis/rtk/commit/316e65ef5baa6b926725b8d9a08c8d2ab52c159d))
* **git:** compact in-progress status state ([cff391e](https://github.com/JerrettDavis/rtk/commit/cff391e50b5fa89ae83eed5fd4274c7c444d37f0))
* **git:** drop -uall from compact status so output never exceeds raw ([06476d1](https://github.com/JerrettDavis/rtk/commit/06476d17cbd49a8a6d06beae9b4a9f0cb9f96f00))
* **git:** drop -uall from compact status so output never exceeds raw ([7753e48](https://github.com/JerrettDavis/rtk/commit/7753e487b3595886d39492be9b43ecad26c826ca))
* **git:** drop state-hint extraction in compact status ([e91dee5](https://github.com/JerrettDavis/rtk/commit/e91dee568bdcca0933b137edccc077db9ff006fa))
* **git:** fix empty output when branch name contains '/' in git diff ([e070226](https://github.com/JerrettDavis/rtk/commit/e0702260a94377b6bbec5cb79d91d81cba17b0ec))
* **git:** fix empty output when branch name contains '/' in git diff ([13188a8](https://github.com/JerrettDavis/rtk/commit/13188a88b22f692157b89874f4c76287a0b3ecae)), closes [#1431](https://github.com/JerrettDavis/rtk/issues/1431)
* **git:** fix panic on multibyte chars in commit output ([4f4a6a0](https://github.com/JerrettDavis/rtk/commit/4f4a6a02ae299495848b644e087acc9da51d4f8c))
* **git:** fix panic on multibyte chars in commit output ([c5ec92f](https://github.com/JerrettDavis/rtk/commit/c5ec92fac8d358e100b12ed2f1e9277bc924bbdd))
* **git:** preserve full status paths and untracked files ([3ba1634](https://github.com/JerrettDavis/rtk/commit/3ba1634555c0b9818560c4f512af916620946181))
* **git:** propagate exit code on git status failure in compact path ([d86f007](https://github.com/JerrettDavis/rtk/commit/d86f0073ec294d75a705c49c95061bd2c09e2b18))
* **git:** propagate exit code on git status failure in compact path ([756c2a4](https://github.com/JerrettDavis/rtk/commit/756c2a4ce84424a17965810392b21c7320b12678))
* **git:** propagate exit code on git worktree list failure ([9a52647](https://github.com/JerrettDavis/rtk/commit/9a52647f6529120723a04e5323f2b38be5b22655))
* **git:** propagate exit code on git worktree list failure ([ebaaf8d](https://github.com/JerrettDavis/rtk/commit/ebaaf8db586a1a31904a122cd815242e183bd536))
* **git:** propagate exit code when commit fails instead of reporting ok ([2927248](https://github.com/JerrettDavis/rtk/commit/29272484de23b1cd1144d97ca6c334da1ee81a61))
* **git:** propagate exit code when commit fails instead of reporting ok ([e36dd8c](https://github.com/JerrettDavis/rtk/commit/e36dd8cbe7cf5f37b6c67115d6d53eccc90c94ab)), closes [#2494](https://github.com/JerrettDavis/rtk/issues/2494)
* **git:** re-insert -- separator when clap consumes it from git diff args ([#1215](https://github.com/JerrettDavis/rtk/issues/1215)) ([9979c69](https://github.com/JerrettDavis/rtk/commit/9979c699307a4adad2c2df0f2bc3b663df653311))
* **git:** remove -u short alias from --ultra-compact to fix git push -u ([6b76fdb](https://github.com/JerrettDavis/rtk/commit/6b76fdb87d7c54cfc2a1b0e6117dd78b8430910b))
* **git:** resolve status completeness conflicts ([6ebde6d](https://github.com/JerrettDavis/rtk/commit/6ebde6d2c277db648b6caefd7063a1bd1873fb6e))
* **git:** stream push output to avoid spurious 30s timeout ([#963](https://github.com/JerrettDavis/rtk/issues/963)) ([d6c5647](https://github.com/JerrettDavis/rtk/commit/d6c56475e818b52b89906baf3a6631aaa506a4c8))
* **git:** stream push output via FilterMode::Streaming ([#963](https://github.com/JerrettDavis/rtk/issues/963)) ([be51783](https://github.com/JerrettDavis/rtk/commit/be5178377fd7c155f70fda94dd134aa5a7b9361d))
* **git:** surface in-progress state in compact `rtk git status` ([017d0f9](https://github.com/JerrettDavis/rtk/commit/017d0f9ee6bb799717958d9f3fd3eee4b0e6ca3c))
* **golangci-lint:** restore run wrapper and align guidance ([4f4e4d2](https://github.com/JerrettDavis/rtk/commit/4f4e4d2b5a3529030fe4089f60d2f4b8740b5d53))
* **golangci-lint:** support inline global flags before run ([24f2ada](https://github.com/JerrettDavis/rtk/commit/24f2adaf8fb541c2564fa7dfb423947932e68fb4))
* **go:** prevent double-counted failures when test-level fail also triggers package-level fail ([#958](https://github.com/JerrettDavis/rtk/issues/958)) ([4fc15ef](https://github.com/JerrettDavis/rtk/commit/4fc15ef2c1c80336ffaafa4179db4cee6f39236a))
* **go:** prevent double-counting failures when package-level fail cascades from test failures ([#958](https://github.com/JerrettDavis/rtk/issues/958)) ([9722d5e](https://github.com/JerrettDavis/rtk/commit/9722d5ebd8916f9b398bdc01b1102d42ab2b8795))
* **go:** respect build failure exit status ([6873764](https://github.com/JerrettDavis/rtk/commit/68737644b761460451e93447b7f06bd8259b2161))
* **go:** respect build failure exit status ([f69ad6e](https://github.com/JerrettDavis/rtk/commit/f69ad6ed6f3f17b66e203613e3015fee517783f9))
* **gradlew:** satisfy semgrep dynamic-command-execution rule ([36ec02d](https://github.com/JerrettDavis/rtk/commit/36ec02d132731dbed41dcf4d124bf957f06695d0))
* **gradlew:** use resolved_command for system gradle fallback ([9e3a5ae](https://github.com/JerrettDavis/rtk/commit/9e3a5ae68d4adc3d7fc374f36235cb5164e6efc8))
* grep false negatives, output mangling, and truncation annotations ([de41533](https://github.com/JerrettDavis/rtk/commit/de415335ea069c06370855366945a3704579ee18))
* grep false negatives, output mangling, and truncation annotations ([9bdf435](https://github.com/JerrettDavis/rtk/commit/9bdf435e8de3a24be213b5d5ab359bd8e7737923))
* **grep:** adjust the command to fall through if the output would already be as small as possible ([09e1c0a](https://github.com/JerrettDavis/rtk/commit/09e1c0ad4b474631b8e058ce69ca2bbd46484c7f))
* **grep:** adjust the command to fall through if the output would already be as small as possible ([021827c](https://github.com/JerrettDavis/rtk/commit/021827c3c9965f6dd4059edc380b1a605b322f39))
* **grep:** code and test cleanup ([7d6255f](https://github.com/JerrettDavis/rtk/commit/7d6255f0e04b9c669f13c0f4cb281ca1029816eb))
* **grep:** command token duplication in output withsame value filename or positional arg ([57e9350](https://github.com/JerrettDavis/rtk/commit/57e935094b0c4b93702f94437f21bbd0248ecf49))
* **grep:** command token duplication in output withsame value filename or positional arg ([89ae19b](https://github.com/JerrettDavis/rtk/commit/89ae19b1cff8251e1b8a0ed590510bef2688bb7d))
* **grep:** correctly handle all flag shapes and never exceed raw output ([ee9e2f8](https://github.com/JerrettDavis/rtk/commit/ee9e2f8a2ad9618495dad0f10763f4891ae47be8))
* **grep:** correctly handle all flag shapes and never exceed raw output ([0adfae6](https://github.com/JerrettDavis/rtk/commit/0adfae6cf61a90a98a007a6ef4a8745ab6f42a31))
* **grep:** fix value-taking flags, -rN clusters, multi-path, and -e patterns ([c40b3ef](https://github.com/JerrettDavis/rtk/commit/c40b3ef9dbefeecff0408b0fd459b8376aeabdc1))
* **grep:** handle value-taking flags in tail position of short clusters ([acb3a2d](https://github.com/JerrettDavis/rtk/commit/acb3a2d5cd0a503883a420acebedb0043c4165a7))
* **grep:** left-to-right cluster scan, long value flags, format passthrough ([b7d93b5](https://github.com/JerrettDavis/rtk/commit/b7d93b509e67eee46de3bb518e7ca71429188a4b))
* **grep:** match real grep output and read piped stdin ([37ee6cf](https://github.com/JerrettDavis/rtk/commit/37ee6cf6fa7ecb1b511aafd0b111b68ba1d5c945))
* **grep:** NUL-separate file from line:content per review ([0e3a6f4](https://github.com/JerrettDavis/rtk/commit/0e3a6f48305c1302443cbe5206e5b5f7cffb671a))
* **grep:** parse single-file output containing colons ([be226d4](https://github.com/JerrettDavis/rtk/commit/be226d4f1dcdcc0df29ad6f9968be5ab37ed5c19))
* **grep:** parse single-file output containing colons ([#1554](https://github.com/JerrettDavis/rtk/issues/1554)) ([8e04ac4](https://github.com/JerrettDavis/rtk/commit/8e04ac4212ea2a7ec680b95a31e17b4c942e6209))
* **grep:** restore strip_r as explicit testable helper + pre-existing clippy fix ([8d29f75](https://github.com/JerrettDavis/rtk/commit/8d29f75833c9afe5eebdb5d6d1ce1743503421e7))
* **grep:** run the invoked engine instead of substituting rg for grep ([eafadce](https://github.com/JerrettDavis/rtk/commit/eafadcee0042411ab9d28339d865a626567a72b0))
* **grep:** stabilize argument parsing ([84616d1](https://github.com/JerrettDavis/rtk/commit/84616d131d77aa853b386b4fdb4a45b52b0c78aa))
* **grep:** stabilize argument parsing — trailing_var_arg, -v invert-match, --version passthrough, safe rg invocation ([d8c550e](https://github.com/JerrettDavis/rtk/commit/d8c550eefba41e112bd174d58844a803db6e432f))
* **grep:** surface error on exit code &gt;= 2 instead of false "0 matches" ([d727db3](https://github.com/JerrettDavis/rtk/commit/d727db3fa1f5b90d94cd8e1b893b6b10418b42bd)), closes [#2461](https://github.com/JerrettDavis/rtk/issues/2461)
* **grep:** surface the engine error and exit code, add nothing ([05f3c54](https://github.com/JerrettDavis/rtk/commit/05f3c54886e6d39476b1e65275c599fe4dc470a3))
* **grep:** use portable --null in system grep fallback (BSD/macOS) ([abe7d42](https://github.com/JerrettDavis/rtk/commit/abe7d4210e0fe5c0b9322ec5210c6a6aadaa3db5))
* handle GNU `--format=long` and `--format=verbose` long args ([8fcc0dc](https://github.com/JerrettDavis/rtk/commit/8fcc0dc56c0bbcdf0508bbf72897085348884fd5))
* head/tail multi-file rewrite falls back to native command ([#1362](https://github.com/JerrettDavis/rtk/issues/1362)) ([f75a10b](https://github.com/JerrettDavis/rtk/commit/f75a10b1a2bd824814247a03bded76fa49ddf663))
* honor explicit -n N limit for git log on merge commits ([26c8890](https://github.com/JerrettDavis/rtk/commit/26c88907d945ec81a25fe631a39dee3830faa0ec))
* honor explicit -n N limit for git log on merge commits ([b3adcb1](https://github.com/JerrettDavis/rtk/commit/b3adcb18ef762d8652272e2ea68c0f416f33c740))
* **hook:** collapse bash line continuations before matching ([#1564](https://github.com/JerrettDavis/rtk/issues/1564)) ([2543be5](https://github.com/JerrettDavis/rtk/commit/2543be59126f5b6825b48570a5b5fb99d0112dab))
* **hook:** collapse bash line continuations before matching ([#1572](https://github.com/JerrettDavis/rtk/issues/1572)) ([39f044e](https://github.com/JerrettDavis/rtk/commit/39f044efd87e5de74c60b090de69882297918dd9)), closes [#1564](https://github.com/JerrettDavis/rtk/issues/1564)
* **hook:** default Copilot CLI rewrite to 'ask' to preserve permission prompts ([69c10b6](https://github.com/JerrettDavis/rtk/commit/69c10b65887527d5cf95e2c48f8c1b58a1fd3077))
* **hook:** emit Copilot CLI-compatible hook config + strip BOM on Windows ([8fb29e2](https://github.com/JerrettDavis/rtk/commit/8fb29e2f75a34d9430be74975cccd30213e619aa))
* **hook:** omit permissionDecision so Copilot prompts for the rewritten command ([db483e6](https://github.com/JerrettDavis/rtk/commit/db483e6c58eccc917864a95282746f9fe52af23c))
* **hook:** preserve Copilot CLI toolArgs metadata when rewriting command ([6c5e440](https://github.com/JerrettDavis/rtk/commit/6c5e440d83b30168c61e4c4b0c79847414a7c509))
* **hook:** rewrite pytest under uv run ([c8722bd](https://github.com/JerrettDavis/rtk/commit/c8722bd55e4441ac377b9c141c5f445e62fe9ecc))
* **hooks/init:** preserve user content in copilot-instructions.md ([a04aa7e](https://github.com/JerrettDavis/rtk/commit/a04aa7e848a28bf5115bfb1d6b706fbff21ea112))
* **hooks/init:** preserve user content in copilot-instructions.md ([d108165](https://github.com/JerrettDavis/rtk/commit/d10816516b4c199b06af18278ab53c76d26c2d87))
* **hooks:** add regression test for windows native ([115e448](https://github.com/JerrettDavis/rtk/commit/115e44853b8cdd2d7af3af2b52c9c31e924a45d3))
* **hooks:** address transparent prefix review ([fdf0ed0](https://github.com/JerrettDavis/rtk/commit/fdf0ed0b597f1ebdc96a2793df2725a1e62bc65c))
* **hooks:** address transparent prefix review comments ([041de2b](https://github.com/JerrettDavis/rtk/commit/041de2b6baa6a27af7d9b429d807fbe887780c90))
* **hooks:** compose env and transparent prefixes ([b234bc6](https://github.com/JerrettDavis/rtk/commit/b234bc6db1ab301334412409a4cfd67fe99c58f0))
* **hook:** semgrep marker + regression tests for Copilot hook isolation ([557e57c](https://github.com/JerrettDavis/rtk/commit/557e57c9f9fe90b090d7bb62024d8bcddd81b732))
* **hooks:** ensure default permission verdict prompts user for confirmation ([40462c0](https://github.com/JerrettDavis/rtk/commit/40462c05e66f116928de365a0d271bdfd61cec72))
* **hooks:** make Cursor preToolUse rewrites work and stay visible ([2d6e10a](https://github.com/JerrettDavis/rtk/commit/2d6e10a923d18e022f5fdc4ed9b69ae0d43b2f79))
* **hooks:** make Cursor preToolUse rewrites work and stay visible ([f00977a](https://github.com/JerrettDavis/rtk/commit/f00977aa338ce6bafe8df69c271679951310b045))
* **hooks:** require all segments to match allow rules ([#1213](https://github.com/JerrettDavis/rtk/issues/1213)) ([40c9dbc](https://github.com/JerrettDavis/rtk/commit/40c9dbc7dbbf9332d6859060765c582a880f0fde))
* **hooks:** windows use 'rtk hook claude' no fallback ([da3c432](https://github.com/JerrettDavis/rtk/commit/da3c432201240f0da9627d8cc6bc70e5b7f8bdfe))
* **hooks:** windows use 'rtk hook claude' no fallback ([0e29650](https://github.com/JerrettDavis/rtk/commit/0e29650e11959730f4c4a2e6d6c0519e14dc8595))
* **hook:** treat uv run as a transparent prefix ([34441dd](https://github.com/JerrettDavis/rtk/commit/34441dd4648d5f73bf40988de0c9f2c839b3e988))
* **hook:** use maintainer regex suggestion for line continuation ([42ac86c](https://github.com/JerrettDavis/rtk/commit/42ac86ce2f5bedb011f84532c2112cd5093500ab))
* **init-uninstall:** uninstall removes --claude-md artifacts on Windows ([d395f97](https://github.com/JerrettDavis/rtk/commit/d395f975c3db7e1cbc825006091e1dcc3867844d))
* **init-uninstall:** uninstall removes --claude-md artifacts on Windows ([aad0db8](https://github.com/JerrettDavis/rtk/commit/aad0db8b5213bd0940ca05f684ecda87de0d93af))
* **init:** honor dry-run for Pi install and uninstall paths ([64ed4f8](https://github.com/JerrettDavis/rtk/commit/64ed4f85504d94ac54e481b289e11362a5f75fdd))
* **init:** make --pi route to Pi-only mode and skip CLAUDE.md injection ([2f163e3](https://github.com/JerrettDavis/rtk/commit/2f163e3a41cbc6e46c814b80976993a73df3bea0))
* **init:** preserve settings.json symlink during atomic write ([508192d](https://github.com/JerrettDavis/rtk/commit/508192dbdcc6a1a753afbd0c87f7255886fad2ea)), closes [#653](https://github.com/JerrettDavis/rtk/issues/653)
* **init:** respect CLAUDE_CONFIG_DIR for global paths ([05de9d3](https://github.com/JerrettDavis/rtk/commit/05de9d366aff627f044e0a40daf5fcbcf277ea30)), closes [#633](https://github.com/JerrettDavis/rtk/issues/633)
* **init:** use fs::canonicalize for symlink resolution ([f1474b4](https://github.com/JerrettDavis/rtk/commit/f1474b4c12ec3a3d9f8e46b14bfd8b2d70119137))
* **install:** reject archive with path traversal before extraction ([#1250](https://github.com/JerrettDavis/rtk/issues/1250)) ([e827184](https://github.com/JerrettDavis/rtk/commit/e8271848d7d6b0d34c2ba5c2c3783ddc48247546))
* **install:** reject archive with path traversal before extraction ([#1250](https://github.com/JerrettDavis/rtk/issues/1250)) ([ac9b22c](https://github.com/JerrettDavis/rtk/commit/ac9b22c4d93f9089d30a3f28043cbe057e445f89))
* **install:** resolve version via redirect to avoid API rate limits ([f67ae3b](https://github.com/JerrettDavis/rtk/commit/f67ae3bcd2b1f0f843b969c3800ee6bf751894f4))
* **install:** resolve version via redirect to avoid GitHub API rate limits ([5e1a641](https://github.com/JerrettDavis/rtk/commit/5e1a64180f094ae456780a78b675f243312089c6))
* isolate cursor hook tests from local settings (determinist) ([d8ddefe](https://github.com/JerrettDavis/rtk/commit/d8ddefe78efe25c35bb2a2f9083f2eacb9dd7274))
* **json:** expand char boundary truncation test ([7840030](https://github.com/JerrettDavis/rtk/commit/784003055e85b5e6a51f69c2ce0b10662f1b36af))
* **json:** use char boundary when truncating long string values ([533894a](https://github.com/JerrettDavis/rtk/commit/533894a77ec5b8f7374547e994124bcf3a730f0b))
* **kubectl:** compact get pods and services aliases ([2dd0ec9](https://github.com/JerrettDavis/rtk/commit/2dd0ec91ab11feea13f5c40755f337208dcb3f7e))
* **kubectl:** compact get pods and services aliases ([b8172e5](https://github.com/JerrettDavis/rtk/commit/b8172e5b1de2fd3a27d992ffba484f01b47d84d4))
* **ls:** add LC_ALL=C and fallback to raw on unrecognized locale ([0d70760](https://github.com/JerrettDavis/rtk/commit/0d70760ef98749203dbaeaebe2323169436afdf3))
* **ls:** distinguish empty dir from unparseable locale content ([25727e3](https://github.com/JerrettDavis/rtk/commit/25727e343dd0eb6727d890e0e13dc53dfa08148c))
* **ls:** handle all file types (device, pipe, socket) in ls filter ([e456be1](https://github.com/JerrettDavis/rtk/commit/e456be1c1674a32839694446504310a2c16ce7dd))
* **ls:** handle device files (block, char, pipe, socket) in ls filter ([cac8ce7](https://github.com/JerrettDavis/rtk/commit/cac8ce775b695c5837b36ea788ba6812bcae214d)), closes [#844](https://github.com/JerrettDavis/rtk/issues/844)
* **ls:** LC_ALL=C + fallback to raw on unrecognized locale ([bf6d4b2](https://github.com/JerrettDavis/rtk/commit/bf6d4b2ea22f026d3ec4d909aef81156b0436509))
* **ls:** LC_ALL=C + fallback to raw on unrecognized locale ([b51a815](https://github.com/JerrettDavis/rtk/commit/b51a815451c18b935633f6690e6c3b93a29b97f8))
* **ls:** preserve permission info as octal when -l/-la is passed ([6c4dfc7](https://github.com/JerrettDavis/rtk/commit/6c4dfc727af0423318bf21a66d53474089d25bf4)), closes [#1672](https://github.com/JerrettDavis/rtk/issues/1672)
* **ls:** preserve permission info as octal when -l/-la is passed ([#1675](https://github.com/JerrettDavis/rtk/issues/1675)) ([6e76f91](https://github.com/JerrettDavis/rtk/commit/6e76f911d6dfffb47fea99417ecde89df36913e4))
* minor code cleanup, avoid duplicating logic ([20cac8a](https://github.com/JerrettDavis/rtk/commit/20cac8a4e7c2b7e0e2675dbcab4fbd0fb1ad79ed))
* minor print_manual_instructions regression ([6785a6c](https://github.com/JerrettDavis/rtk/commit/6785a6c7695d7273e722214a295249a84819b6f0))
* **mvn:** keep multi-module Reactor Summary rows ([4609102](https://github.com/JerrettDavis/rtk/commit/460910267b8a8876f4459ee93cbef074a61c39b6))
* **mvn:** match Surefire 3.x close lines, preserve failure stack trail ([cc152cd](https://github.com/JerrettDavis/rtk/commit/cc152cd2ac9bfd5085b1b178a78088c11a37b0ae))
* **mvn:** preserve compile-error continuation in filter_surefire ([97bd2a7](https://github.com/JerrettDavis/rtk/commit/97bd2a7787c459e2df396bb3d28b9660b35c5ec6))
* **mvn:** re-arm failure trail on per-test sublines ([1050cfe](https://github.com/JerrettDavis/rtk/commit/1050cfeadcc3fd2b34df3401c6ec3aa09f0cd199))
* **mvn:** strip post-failure help boilerplate in non-quiet mode ([df76528](https://github.com/JerrettDavis/rtk/commit/df76528dd36dba4a58163a4827d34fbb9e7c17ca))
* new rewite_command test call after rebase ([5cfb8e1](https://github.com/JerrettDavis/rtk/commit/5cfb8e1d2bdf85d60633868cb420aba9a7b923f4))
* **npm:** regex match end line ([5e84e94](https://github.com/JerrettDavis/rtk/commit/5e84e9471736fe58e89094854f4123ecb07c2d3b))
* **npx:** dispatch unknown tools to npx instead of npm ([2c4569c](https://github.com/JerrettDavis/rtk/commit/2c4569caa64d013ad4ada0b7580f9f16d8334c19)), closes [#815](https://github.com/JerrettDavis/rtk/issues/815)
* **openclaw:** no execSync to avoid async dangerous cmds ([f525cee](https://github.com/JerrettDavis/rtk/commit/f525ceecf4dbaa522d70b83ca36cac5992684a92))
* **openclaw:** no execSync to avoid async dangerous cmds ([1bb17f4](https://github.com/JerrettDavis/rtk/commit/1bb17f4fd18ef9470ba5a0c1341a35b26819da39))
* P0+P1 fixes from pre-merge review of hook engine ([df8e035](https://github.com/JerrettDavis/rtk/commit/df8e03558d4d6cc2f5cbac91c63ab1b3b51d3bcd))
* P0+P1 fixes from pre-merge review of hook engine ([d34389c](https://github.com/JerrettDavis/rtk/commit/d34389c3d0936c2b0790e14f450bb50a28a7edf7))
* **permissions:** &gt;&file redirect no allow + scope Gemini/Cursor config ([e16aa26](https://github.com/JerrettDavis/rtk/commit/e16aa26162a95bd99c954c0236b5353ffe89db00))
* **permissions:** &gt;&file redirect no allow + scope Gemini/Cursor config ([ce36297](https://github.com/JerrettDavis/rtk/commit/ce362970e5752bacfd3a356c7fa122fea94ff0b2))
* **permissions:** add test for cursor and gemini settings perm ([1ccf6e3](https://github.com/JerrettDavis/rtk/commit/1ccf6e3da72b6c2feff43bbc4d9fc3ed2e4cd083))
* **permissions:** add test for cursor and gemini settings perm ([f181184](https://github.com/JerrettDavis/rtk/commit/f181184b4017d71aa7f557148a2d7f1b872ab6d2))
* **permissions:** cursor and gemini use correct permissions settings file ([a4bb55e](https://github.com/JerrettDavis/rtk/commit/a4bb55efa9be1b0bf69ccc2cff9ddcbf2af7a48d))
* **permissions:** cursor and gemini use correct permissions settings file ([6ab149b](https://github.com/JerrettDavis/rtk/commit/6ab149ba3e41bb41b99794ef55d384c9be96b91b))
* **permissions:** glob_matches middle-wildcard matches commands without trailing args ([#1105](https://github.com/JerrettDavis/rtk/issues/1105)) ([3db8070](https://github.com/JerrettDavis/rtk/commit/3db8070b51b9a312fcca20a8460d3d6259cc38b7))
* **permissions:** never auto-allow not evaluable + defer to the agent ([952245d](https://github.com/JerrettDavis/rtk/commit/952245d39d099ed9a804dbba21bb0486f6aede16))
* **permissions:** never auto-allow not evaluable + defer to the agent ([cdcdb68](https://github.com/JerrettDavis/rtk/commit/cdcdb6863a3df709603dbed0a6205bf16e4e635f))
* **permissions:** never auto-allow not evaluable cmds, defer to hosts ([e1bc0bd](https://github.com/JerrettDavis/rtk/commit/e1bc0bd9d0e52d98323714a3b163c359d6a240d2))
* **permissions:** project-first config lookup for Gemini/Cursor ([f88b6be](https://github.com/JerrettDavis/rtk/commit/f88b6bec1323265cfced77c449bd795f2506cc90))
* **permissions:** project-first config lookup for Gemini/Cursor ([084fa84](https://github.com/JerrettDavis/rtk/commit/084fa84e9a58387b5d77ca68db8731d361a89f2b))
* **pipe:** apply the never-worse guard ([9d9ad7c](https://github.com/JerrettDavis/rtk/commit/9d9ad7cb177a1da22c4395dc6716fdf5e640a6f3))
* **pkg:** rtk is Apache 2.0 and no MIT ([fa11c6c](https://github.com/JerrettDavis/rtk/commit/fa11c6c3ebe55f36a0c09f15995333cda19a737a))
* **pkg:** rtk is Apache 2.0 and no MIT ([1875945](https://github.com/JerrettDavis/rtk/commit/1875945bf32b3cc8f7f4c8da81427e17ded74c7f))
* **pnpm:** install don't take a list of packages ([492aa76](https://github.com/JerrettDavis/rtk/commit/492aa76ed3842549d2a453becbf2782caba765f1))
* **pnpm:** install don't take a list of packages ([9a50efa](https://github.com/JerrettDavis/rtk/commit/9a50efadc38c71cc4a0f3cb05b46cbe41d925a0c))
* **pnpm:** list command not working ([ba235d8](https://github.com/JerrettDavis/rtk/commit/ba235d85974c0a85b25e290a8bb83648800438a6))
* prevent crashes when output is piped ([acfd6c5](https://github.com/JerrettDavis/rtk/commit/acfd6c5889b00255064b13b83a39808cc57d2605))
* **provider:** sanatize more chars when encoding claude code project pathes ([653a209](https://github.com/JerrettDavis/rtk/commit/653a209485601c4f0ba22ca44cff3d11cb38fc5c))
* **provider:** sanatize more chars when encoding claude code project pathes ([5989ac9](https://github.com/JerrettDavis/rtk/commit/5989ac91b008dece0d36b62c2deb169a90d5063d)), closes [#2150](https://github.com/JerrettDavis/rtk/issues/2150)
* **pulumi:** address review feedback + JSON-safety ([888d1a8](https://github.com/JerrettDavis/rtk/commit/888d1a8f77861354e730ac8ae22067d0fd35c8c7))
* **pulumi:** keep Owner and version in pulumi-stack filter ([5cfe4d5](https://github.com/JerrettDavis/rtk/commit/5cfe4d5f87cecc7996cdbd837b7bf3dab2518a4e))
* **pulumi:** keep stack identity in pulumi-stack filter ([1f6e36b](https://github.com/JerrettDavis/rtk/commit/1f6e36b27ef4fd2237465c97a8e73fbe4e990f61))
* **pytest:** -q mode summary line not detected ([57502a5](https://github.com/JerrettDavis/rtk/commit/57502a5bef1fb56109a57cf2ea7377fd271253a7))
* re-add env python as noisy dir ([4eefe2f](https://github.com/JerrettDavis/rtk/commit/4eefe2f225ea512a2f1bf800dd20c09994721108))
* **read:** make guard baseline faithful to cat/cat -n output ([9a2ad90](https://github.com/JerrettDavis/rtk/commit/9a2ad90360b39ba8786f6056188ee9a939a9db28))
* remove pnpx -&gt; rtk pnpx rule as rtk pnpx command doesn't exist ([325a42e](https://github.com/JerrettDavis/rtk/commit/325a42e09fd8de6d0c26914ff29ab11d8680f354))
* remove remaining noise and rework comments ([3c356b3](https://github.com/JerrettDavis/rtk/commit/3c356b32416be0815bee9e4364c20c4efa15d829))
* remove wrong cicd benchmark + npm test regex ([7e3690a](https://github.com/JerrettDavis/rtk/commit/7e3690a23ab158ca8e1e890650554e20e3a0c17b))
* rename ship.md to ship/SKILL.md to match develop ([5916ecd](https://github.com/JerrettDavis/rtk/commit/5916ecd86fb319c2519a0b4fb2891309833a3bb4))
* reset SIGPIPE to default handler to avoid panic ([49a094a](https://github.com/JerrettDavis/rtk/commit/49a094ac9ba7615a14f2ee0b8fad10932ffe76f7))
* resolve merge conflict artifacts in init.rs ([4830d50](https://github.com/JerrettDavis/rtk/commit/4830d50f6e3ad7adbd24ba11f3e392869723a020))
* **runner:** preserve fd separation on command failure ([e92d099](https://github.com/JerrettDavis/rtk/commit/e92d0993c93f0b732316dfa932d265aeca7488d6))
* **rust:** multi-line blocks used with tail hint ([4960630](https://github.com/JerrettDavis/rtk/commit/49606303d6738525c250149230752fb6133383d1))
* **security:** harden installer checksum, filter-trust, meta-command ([769b6ce](https://github.com/JerrettDavis/rtk/commit/769b6ce5a44ec696bf40d845a7fea35cdb5f7699))
* **security:** harden installer checksum, filter-trust, meta-command fallthrough ([9cc4937](https://github.com/JerrettDavis/rtk/commit/9cc4937dac3ba9aa27147699afe66a2842e7bffc))
* **security:** harden meta command list check ([069a089](https://github.com/JerrettDavis/rtk/commit/069a089c409193115b83fd27438d1bd73bf876b0))
* **security:** pin workflow actions to SHA, clean up tempfile on failure ([26b96ec](https://github.com/JerrettDavis/rtk/commit/26b96ec6c4f40f992ccffa190af9a4de8d7636b1))
* **security:** port permission hardening from master + Copilot CLI adaptation ([e1cd274](https://github.com/JerrettDavis/rtk/commit/e1cd274ab9f3d473b694547e511e5baf1eae9734))
* **security:** replace insecure tmp, lock git perm, set sha for actions ([54d1f87](https://github.com/JerrettDavis/rtk/commit/54d1f8736f4acdd0667eb86c81d0e4c7843306f4))
* **security:** replace insecure tmp, lock git workflow perm ([cd6ac2f](https://github.com/JerrettDavis/rtk/commit/cd6ac2f47a008c6dca04b567faf68aaedfd87ca9))
* semgrep markers on test-fixture sensitive paths ([66d66b1](https://github.com/JerrettDavis/rtk/commit/66d66b1fe6293e0f93d9797ae04e72b7ca40eaa0))
* **stream:** add semgrep flag for sh tests ([7cfcdbe](https://github.com/JerrettDavis/rtk/commit/7cfcdbec8681b15b794b6aef982ccb38feb79fd7))
* **stream:** add semgrep flag for sh tests ([d327724](https://github.com/JerrettDavis/rtk/commit/d327724f814b6875903366db0b0616780b454ad1))
* **stream:** missing stderr fields ([a1d46f3](https://github.com/JerrettDavis/rtk/commit/a1d46f39c291e3356b9c26a062bde05ba1de591a))
* **stream:** route to respective fd ([605e335](https://github.com/JerrettDavis/rtk/commit/605e335f0546d2ed8554a95e7749a0b494c510e3))
* **stream:** route to respective fd ([81a1be6](https://github.com/JerrettDavis/rtk/commit/81a1be6a744942515347dd296ddcf7d9f126200d))
* **tee:** safe truncation caps and compose-ps tee content fix ([548e4dd](https://github.com/JerrettDavis/rtk/commit/548e4dd995d5de6e52d7c8e7bb0a0f81fa2c0328))
* **tee:** safe truncation caps and tee/hint coverage ([15a0d2e](https://github.com/JerrettDavis/rtk/commit/15a0d2e7d6e3f33442675f502ed8bc868710dfd6))
* **telemetry:** clean code ([8156081](https://github.com/JerrettDavis/rtk/commit/81560812610686fa5ca3633c2bf0b79c05eaa7d9))
* **telemetry:** consent, erasure, auth, docs ([2e4cc4b](https://github.com/JerrettDavis/rtk/commit/2e4cc4bb5226444c8c0bfc827baf0c101c3759e8))
* **telemetry:** non-terminal consent, single config load ([7821e98](https://github.com/JerrettDavis/rtk/commit/7821e9872fd1f1ae9b40eb8a4458049869acc36b))
* **telemetry:** RGPD-compliant, consent gate, erasure, privacy controls ([6a5bc84](https://github.com/JerrettDavis/rtk/commit/6a5bc847e06cf6066e6f4aeed5a3ad0803a3649b))
* **tests:** resync & list oc as passthrough for test ([444f1c0](https://github.com/JerrettDavis/rtk/commit/444f1c09082f8a9a843499980f89b8c0682ddfef))
* **tests:** update init.rs test calls for dry_run parameter ([add1464](https://github.com/JerrettDavis/rtk/commit/add14643886e1b2c5450056433e577c003872e4d))
* **tests:** use rewrite_command_no_prefixes in line-continuation tests ([0ec99de](https://github.com/JerrettDavis/rtk/commit/0ec99de8f4ef102c10a827b57636278080e2f3cf))
* **tests:** windows regression test fix path ([13a73dd](https://github.com/JerrettDavis/rtk/commit/13a73ddfd78460560a1f5fde94b54b1f848b41b5))
* **tracking:** test env path ([70b36b4](https://github.com/JerrettDavis/rtk/commit/70b36b4dbc3e147219ad87cf539d073523b86a85))
* **truncate:** global caps reduce (avoid underflow and 0 results) ([d5a1731](https://github.com/JerrettDavis/rtk/commit/d5a17315c52487be2d043e0058a4f7d91ec3d2bc))
* **vitest:** add passthrough recovery hint ([f9469d1](https://github.com/JerrettDavis/rtk/commit/f9469d12cfb48a6dda2b8c0578a7d5696804ae5f))
* **vitest:** preserve explicit reporters ([e3f60e9](https://github.com/JerrettDavis/rtk/commit/e3f60e982261cd4a488a9f4593c40b13738f5f35))
* **vitest:** preserve explicit reporters ([e9b82fc](https://github.com/JerrettDavis/rtk/commit/e9b82fc2bbd8100cbc200ae3dba6de49a05bcb26))
* **vitest:** rework command to handle differences between vitest and jest ([70610da](https://github.com/JerrettDavis/rtk/commit/70610da4bbf0fd8f4226fc61895af61377eafcc8))
